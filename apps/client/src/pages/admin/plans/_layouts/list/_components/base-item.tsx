  ...
  >
    <div className="flex w-full items-center justify-between">
      <div className="flex items-center space-x-4">
        ...
        <p className="hidden text-xs opacity-75 sm:block">{price}</p>
        <p className="hidden text-xs opacity-75 sm:block">{duration}</p>
        <p className="hidden text-xs opacity-75 sm:block">{status}</p>
